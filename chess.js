...
//         if (isHovered) {
//             square.firstElementChild.classList.remove('hover');
//         } else {
//             square.firstElementChild.classList.add('hover');
//         }
//         isHovered = false;
//     });
...
function dragDrop(e) {
    ...
    if (correctGo) {
        ...
        if (taken && !takenByOpponent) {
            infoDisplay.textContent = 'You can\'\t go there';
